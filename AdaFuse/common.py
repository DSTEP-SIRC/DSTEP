...
def set_manual_data_path(data_path, exps_path):
    ...
    global JESTER_NOV21_FRAMES
    JESTER_NOV21_FRAMES = ospj(DATA_PATH, "JesterSubset")

    global MINIK_NOV21_FRAMES
    MINIK_NOV21_FRAMES = ospj(DATA_PATH, "Kinetics_400", "mini_kinetics_frames")