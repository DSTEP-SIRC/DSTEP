...
parser.add_argument('--num_segments', type=int, default=3) # YD: Number of frames sampled from each clip (creating a super-frame)
...
# TODO AdaR
parser.add_argument('--ada_reso_skip', action='store_true', help='adaptively select scale and choose to skip') # YD: Need to set this flag to disable adaptive resolution
...
parser.add_argument('--gate_bn_between_fcs', '--gbn', action='store_true') # YD: Add BN between the fcs i
...
parser.add_argument('--gate_history', action='store_true') # YD: enable in order to use channels from history in policy
...
parser.add_argument('--static_flops_table_path', type=str, default="")
parser.add_argument('--model_desc_table_path', type=str, default="")
parser.add_argument('--debug_frames_dir_path', type=str, default="")
parser.add_argument('--categories_file_apth', type=str, default="")

parser.add_argument('--spatial_masking', action='store_true')
parser.add_argument('--den_target', default=0.5, type=float, help='target density of the spatial_mask.') # TODO YD: probably temporary and should be merged with channel+temporal sparsity
parser.add_argument('--spatial_lambda', default=5, type=float, help='loss weight of spatial sparsity') # TODO YD: probably temporary and should be merged with channel+temporal sparsity
parser.add_argument('--spatial_gamma', default=1, type=float, help='loss weight of bound regularization of spatial sparsity') # TODO YD: probably temporary and should be merged with channel+temporal sparsity
parser.add_argument('--bound_reg_alpha', default=5e-2, type=float,  help='alpha in exp annealing for spatial sparsity') # TODO YD: probably temporary and should be merged with channel+temporal sparsity
parser.add_argument('--dgnet_pretrained_path', type=str, default="")
parser.add_argument('--debug_frames_spatial_masks', action='store_true')
